...
public class Pokerito {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("Here's is the computer's card: \n" + compCard);
         ...
         */
        System.out.println("You have " + yourMatches + " matches");
        System.out.println("The computer has " + computerMatches + " matches");
